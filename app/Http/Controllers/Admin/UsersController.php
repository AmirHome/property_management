...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->rawColumns(['actions', 'placeholder', 'picture', 'roles']);
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'userCrmCustomers', 'userCrmDocuments', 'userTasks', 'ownerTeams', 'landlordUnits', 'tenantUnits', 'tenantContracts', 'userMaintenanceRequests', 'userAmenityReservations', 'userUserAlerts');
