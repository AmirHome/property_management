    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contracts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_amount') ? 'is-invalid' : '' }}" type="number" name="rent_amount" id="rent_amount" value="{{ old('rent_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_link') ? 'is-invalid' : '' }}" type="text" name="contract_link" id="contract_link" value="{{ old('contract_link', '') }}">
