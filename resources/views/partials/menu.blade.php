<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('definition_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/countries*") ? "c-show" : "" }} {{ request()->is("admin/provinces*") ? "c-show" : "" }} {{ request()->is("admin/settings*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @endcan
        @can('amenity_reservation_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.amenity-reservations.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/amenity-reservations") || request()->is("admin/amenity-reservations/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
